...
<script lang="ts">
    ...
    import { setContext, getContext, type ComponentProps, createEventDispatcher } from "svelte";
	...
	let cs: string, specText: string|true = true, text: string, specLabel: string|true = '', label: string, errors: string[]|undefined = undefined;
