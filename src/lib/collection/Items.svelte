...
<script lang="ts">
	...
	export let activeKey: T | undefined = undefined, autoActivate: boolean = false;
	let prvAK: T | undefined = undefined;
	...
	function activate(key: T|undefined, active: boolean = true) {
		if(!active) 
